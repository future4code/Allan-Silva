...
// O codigo esta executando um loop fazendo com que a let valor tenha o mesmo ou maior valo que a let i . Sendo assim ira imprimir o valor de 4 no console

// Exercicio 2

// Ele esta pedindo para que imprimi o numero da array maior que 18 em diante
...
// for(let numberA of array) {
//     console.log("A." ,numberA)
// }

// B.

// for(let numberB of array ) {
//     if(numberB) {
//         console.log("B.",numberB/10)
//     }
// }

// C.

// for (let numberC of array) {
//     if(numberC%2 === 0 ) {
//         let arrayC = []
//         console.log(arrayC[numberC])
//     }
// }
...
console.log("O maior número é " + higher + " e o menor é " + smallest )